...
\\
\textbf{Ipotesi induttiva}: ogni \(2\leq a<n\;\;(2\leq a\leq n-1)\) è fattorizzabile in irriducibili: \(\exists\; \alpha _1...\alpha _t \alpha _i\leq 1\) e \(q_1,...q_t\) irriducibili con \(a=q_1^{\alpha _1}...q_t^\alpha _t\)
\\
